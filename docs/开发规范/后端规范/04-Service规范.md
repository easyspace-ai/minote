...
import (
    ...
    "github.com/easyspace-ai/minote/internal/repository"
)
...
func (s *userService) Create(ctx context.Context, req CreateUserRequest) (*UserDTO, error) {
    ...
    if err != nil && !errors.Is(err, notex.ErrRecordNotFound) {
...
```go
// ❌ 依赖 net/http
func (s *userService) Create(w http.ResponseWriter, r *http.Request, req CreateUserRequest) (*UserDTO, error)
